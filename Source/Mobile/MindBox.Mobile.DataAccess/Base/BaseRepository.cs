...
namespace MindBox.Mobile.DataAccess
{
    ...
    /// </summary>
    public abstract class BaseRepository<T, K> : IRepository<T, K> where T : class, IBaseEntity<K>, new()
    {
        ...
        /// </summary>
        protected MindBoxMobileDbContext Db { get; set; }
        ...
        public BaseRepository(MindBoxMobileDbContext db)
        {
            Db = db;
        }
